...
return array(
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'MelisDemoCommerce/plugin/new-arrivals'                     => __DIR__ . '/../view/plugins/new-arrivals.phtml',
            'MelisDemoCommerce/plugin/discount-featured-onsale-slider'  => __DIR__ . '/../view/plugins/discount-featured-onsale-slider.phtml',
            'MelisDemoCommerce/plugin/category-list-filter'             => __DIR__ . '/../view/plugins/category-list-filter.phtml',
            'MelisDemoCommerce/plugin/category-price-filter'            => __DIR__ . '/../view/plugins/category-price-filter.phtml',
            'MelisDemoCommerce/plugin/category-color-filter'            => __DIR__ . '/../view/plugins/category-color-filter.phtml',
            'MelisDemoCommerce/plugin/category-size-filter'             => __DIR__ . '/../view/plugins/category-size-filter.phtml',
            'MelisDemoCommerce/plugin/category-product-list'            => __DIR__ . '/../view/plugins/category-product-list.phtml',
            'MelisDemoCommerce/plugin/category-paginator'               => __DIR__ . '/../view/plugins/category-paginator.phtml',
            ...
            'MelisDemoCommerce/plugin/show-cart-menu'                   => __DIR__ . '/../view/plugins/show-cart-menu.phtml',
