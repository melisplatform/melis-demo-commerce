...
// 					.nextAll()
// 					.remove();
// 				$(form + " input[name='" + i + "']").after(
// 					'<div class="frm-err-prompt" style="color:#bb0000"><li class="error-details">' +
// 						value +
// 						"</li></div>"
// 				);
...
// 					.nextAll()
// 					.remove();
// 				$(form + " select[name='" + i + "']").after(
// 					'<div class="frm-err-prompt" style="color:#bb0000"><li class="error-details">' +
// 						value +
// 						"</li></div>"
// 				);

// 				$(form + " textarea[name='" + i + "']")
// 					.nextAll()
// 					.remove();
// 				$(form + " textarea[name='" + i + "']").after(
// 					'<div class="frm-err-prompt" style="color:#bb0000"><li class="error-details">' +
// 						value +
// 						"</li></div>"
// 				);
